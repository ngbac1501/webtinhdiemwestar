...
class MobileAppUX {
  ...
  showInstallButton(deferredPrompt) {
    ...
    installBtn.className = 'fixed bottom-24 right-4 z-40 bg-cyan-600 hover:bg-cyan-700 text-white px-4 py-3 rounded-lg font-medium shadow-lg transition-all flex items-center gap-2 animate-slideInUp lg:hidden';
